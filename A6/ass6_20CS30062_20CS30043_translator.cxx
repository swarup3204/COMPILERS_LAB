...
void symbol_value::set_initial_value(int val) {
    c = f = i = val;
    p = NULL;
}

void symbol_value::set_initial_value(char val) {
    c = f = i = val;
    p = NULL;
}

void symbol_value::set_initial_value(float val) {
    c = f = i = val;
    p = NULL;
}
...
symbol* symbol_table::lookup(string name, DataType t, int pc) {
...
string symbol_table::gentemp(DataType t) {
